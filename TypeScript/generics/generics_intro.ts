...
const stringResult:"Hello Kajal" = logAndReturn("Hello Kajal");
...
function add<T extends number | string>(a: T, b: T): T {
    return a as any + b as any; // Using "as any" to suppress TypeScript error
}

const result1: number = add(5, 10); // Output: 15
const result2: string = add("Hello, ", "world!"); // Output: Hello, world!
